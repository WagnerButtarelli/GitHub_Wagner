...
sheet.appendRow(['Código', 'Produto', 'Quantidade', 'Data Validade', 'Categoria', 'Subcategoria', 'Preço Custo', 'Preço Venda', 'Fornecedor', 'Estabelecimento', 'Quebra', 'Cadastrado Por', 'Função', 'Data Cadastro', 'Resolvido']);
...
// Auto-migração: planilha Estoque já existente sem as colunas de auditoria ganha os cabeçalhos automaticamente
if (name === 'Estoque' && sheet.getLastColumn() < 14) {
sheet.getRange(1, 12, 1, 3).setValues([['Cadastrado Por', 'Função', 'Data Cadastro']]);
}
// Auto-migração: planilha Estoque já existente sem a coluna Resolvido (Ações Rápidas) ganha o cabeçalho automaticamente
if (name === 'Estoque' && sheet.getLastColumn() < 15) {
